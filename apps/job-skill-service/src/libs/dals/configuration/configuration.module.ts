...
import { configs } from 'apps/job-skill-service/src/configs';
import { AppConfigServiceProvider } from './providers';

// App root: apps/job-skill-service/ (relative to project root)
const APP_ROOT = join(process.cwd(), 'apps/job-skill-service');
