...
import { configs } from "apps/job-application-service/src/configs";
import { AppConfigServiceProvider } from "./providers";

// App root: apps/job-application-service/ (relative to project root)
const APP_ROOT = join(process.cwd(), "apps/job-application-service");
