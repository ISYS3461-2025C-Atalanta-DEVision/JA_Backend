...
export class NotificationController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get notifications', description: 'Get paginated notifications for current user' })
  ...
  async markAsRead(
    ...
    this.logger.log(`User ${user.email} marking notification ${notificationId} as read`);
    try {
      const result = await firstValueFrom(
        this.notificationClient
  ...
  @Post('mark-all-read')
  @ApiOperation({ summary: 'Mark all notifications as read', description: 'Mark all notifications as read for current user' })
