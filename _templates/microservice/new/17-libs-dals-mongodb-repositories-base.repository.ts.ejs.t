---
to: apps/<%= kebabName %>/src/libs/dals/mongodb/repositories/base.repository.ts
---
...
export abstract class BaseMongoRepository<T>
  ...
  async findManyAndCount(filter: FilterQuery<T> = {}, options: QueryOptions<T> = {}): Promise<[T[], number]> {
